...
| Foundation | 2 | Q1.2 — Tagline | Forces clarity. Rich strategic signal for positioning and executive summary. |
| Foundation | 3 | Q1.3 — Detailed Description | Single richest data source. Non-negotiable. |
| Foundation | 4 | Q1.4 — Industry | Competitive and cultural context for strategy and creative direction. |
| Foundation | 5 | Q1.7 — Stage & Scale | Calibrates ambition and DNA score baselines. Required. |
| Foundation | 6 | Q1.8 — Founder Story | Founder intent is a first-class strategic input. NON-NEGOTIABLE. |
| Foundation | 7 | Q1.9 — Vision & Mission | Strategic ambition ceiling. Shapes brand purpose in strategy. |
| Foundation | 8 | Q1.10 — Core Values | Guardrails for every creative decision. Feeds Brand DNA and contradiction detection. |
| Foundation | 9 | Q1.12 — Brand Goals | Why branding now? Critical framing for strategy priorities. |
| Positioning | 10 | Q2.1 — Primary Customer | Personas make strategy specific. Required. |
| Positioning | 11 | Q2.2 — Pain Points | Drives positioning, messaging, and problem-statement framing. |
| Positioning | 12 | Q2.3 — Desires & Aspirations | Emotional driver. Required for archetype selection and emotional positioning. |
| Positioning | 13 | Q2.4 — Competitive Awareness | Required for competitive analysis. Use the 3-layer framework. |
| Positioning | 14 | Q2.5 — Competitive Differentiation | Per-competitor evidence for USP and Brand Promise. Conditional-required — triggered by Q2.4 when competitors exist. Protects against LLM-invented competitor analysis. |
| Positioning | 15 | Q2.6 — USP | Anchor of the strategy. Required with specificity check. |
| Positioning | 16 | Q2.8 — Brand Promise | Litmus test for all strategic and creative decisions. |
| Personality | 17 | Q3.1 — Archetype | Single most powerful personality framework. Required. |
| Personality | 18 | Q3.2 — Personality Traits | Operationalizes archetype. Required for nuanced strategy. |
| Personality | 19 | Q3.3 — Tone of Voice | Voice definition. Required for messaging and copy strategy. |
| Personality | 20 | Q3.7 — Keywords | Semantic building blocks woven throughout the strategy. Required. |
| Personality | 21 | Q3.8 — Never Keywords | Quality control — prevents AI from using rejected language. Required. |
| Inspiration | 22 | Q4.1 — Brand Inspirations | Taste signal for creative direction. Required with reasons. |
| Inspiration | 23 | Q4.3 — Emotional Response | Emotional KPI for strategy and creative direction. Required. |
| Creative | 24 | Q5.2 — Color Psychology | Required for creative direction color strategy. |
| Creative | 25 | Q5.4 — Typography Personality | Required for creative direction typography recommendations. |
...
| Phase | # | Question | Value-add | Deferral cost | Moved from |
|-------|---|----------|-----------|---------------|------------|
| Foundation | Q1.6 | Country / Primary Market | Cultural context for strategy and CD | Low–Medium — Q1.3 captures most context | V1 Must-Have |
| Foundation | Q1.6a | Market Adaptation | Important for international brands | Low for domestic-only brands | — |
| Foundation | Q1.11 | Business Goals (12-Month) | Aligns branding to business outcomes | Medium — Q1.12 captures "why now" framing | V1 Must-Have |
...
| Inspiration | Q4.2 | Brand Confusion | Aesthetic peer group calibration | Low–Medium — Q4.1 provides core taste signal | V1 Must-Have |
| Creative | Q5.1 | Design Sensibility (6 sliders) | Precise visual calibration | High — CD has less guidance | — |
...
| Creative | Q5.8 | Website Goals | Important for website module | Deferred to V2 | — |
| Creative | Q5.9 | Marketing Goals | Important for marketing module | Deferred to V2 | — |

### 8.3 Defer to V2

These are explicitly designed but should NOT ship in the next sprint. Questions moved here from V1 Must-Have because they primarily serve modules that don't exist yet (Logo, Brandbook, Website, Marketing):

| Question | Reason for deferral | Target version |
|----------|---------------------|----------------|
| Q1.5 — Products & Services | Redundant with Q1.3 (Detailed Description) for S+CD. Tangible grounding is valuable for future modules (L, W, M) but not essential for strategy-only output. | V2 |
| Q4.4 — Visual Reference Uploads | Needs image handling, storage, analysis infrastructure. | V2 |
| Q5.5 — Logo Sensibility | Logo module does not exist. Consumed primarily by L, BB, W, M (all future). No S or CD consumption. | V3 |
| Q5.7 — Existing Assets | Primarily serves L, BB, W. CD signal ("evolution vs. creation") is valuable but secondary. Returns when Logo/Website modules ship. | V2 |
| Q5.7a — Existing Asset Details | Conditional on Q5.7. Return together. | V2 |
| Q5.7b — Logo Attachment Check | Conditional on Q5.7a replace. Return together. | V2 |
| Full Rebranding Branch (Section 4.2) | Requires multiple future modules and brand equity analysis. | V3 |
| Phase Reflections | Nice UX but non-critical for strategy generation. | V2 |
| Coherence scoring visualization | Radar chart on Review screen. | V2 |
| Contradiction resolution UI beyond inline notices | Advanced UX for contradiction handling. | V2 |

**Deferral philosophy:** Every question moved to V2/V3 preserves its full design in Section 3. Nothing is deleted — only deferred until its consuming module exists. When Logo (V3) ships, Q5.5 returns. When Website (V2) ships, Q5.7 returns.
...
|------|--------------|----------------|----------------|
| 1. Your Business | Foundation Q1.1–Q1.4 | 4 | 3–4 min |
| 2. Vision & Goals | Foundation Q1.7–Q1.12 (excl. Q1.11) | 5 | 5–7 min |
| 3. Your Customers | Positioning Q2.1–Q2.4 | 4 | 5–7 min |
| 4. Your Position | Positioning Q2.5, Q2.6, Q2.8 | 3 | 4–6 min |
| 5. Brand Personality | Personality Q3.1–Q3.3, Q3.7–Q3.8 | 5 | 5–7 min |
| 6. Inspiration & Feel | Inspiration Q4.1, Q4.3 | 2 | 3–5 min |
| 7. Creative Direction | Creative Q5.2, Q5.4 | 2 | 3–5 min |
| **Total** | | **25** | **29–44 min** |
...
| "Confused with" exists but underused | Q4.2 moved to Nice-to-Have; Q4.1 covers taste | Deferred until more modules exist |
...
| Logo type isn't asked | Q5.5 Logo sensibility deferred to V3 | Returns when Logo module ships |
...
| Foundation | Q1.5 | Products & Services | ✅ Required | Textarea | S, CD, L, W, M | No | Deferred |
| Foundation | Q1.6 | Country / Primary Market | ✅ Required | Dropdown + multi-chips | S, CD, W, M | Yes — Q1.6a if multi-market | Nice |
| Foundation | Q1.6a | Market Adaptation | 🔀 Conditional | Radio (3 options) | S, CD, BB, W | Triggered by Q1.6 multi-market | Deferred |
...
| Foundation | Q1.11 | Business Goals (12-Month) | ✅ Required (≥1) | Checklist + text inputs | S, CD, W, M | Yes — Q1.11a if Fundraising | Nice |
| Foundation | Q1.11a | Investor Audience | 🔀 Conditional | Textarea | S, CD, W, M | Triggered by Q1.11 Fundraising | Deferred |
...
| Inspiration | Q4.2 | Brand Confusion | ⭕ Optional | Text input + autocomplete | S, CD, L | No | Nice |
...
| Creative | Q5.5 | Logo Sensibility | ✅ Required | Visual type cards (6) | L, BB, W, M | Yes — abstract mark prompt | Deferred |
| Creative | Q5.6 | Logo References | ⭕ Optional | Repeater (name + reason + URL) | L, CD | No | Nice |
| Creative | Q5.7 | Existing Assets | ✅ Required | Multi-select + upload (V2) | CD, L, BB, W | Yes → Section 4.1 branch | Deferred |
| Creative | Q5.7a | Existing Asset Details | 🔀 Conditional | Textarea + Keep/Evolve/Replace | CD, L, BB, W, M | Triggered by Q5.7 assets | Deferred |
| Creative | Q5.7b | Logo Attachment Check | 🔀 Conditional | Radio + textarea | S, L, M | Triggered by Q5.7a Replace | Deferred |
| Creative | Q5.8 | Website | Creative | Q5.8 | Website & Digital Goals | ⭕ Optional | Multi-select cards + text | W, CD, BB | No | Nice | Digital Goals | ⭕ Optional | Multi-select cards + text | Future: Website, CD, BB | No | Deferred |
| Creative | Q5.9 | Marketing Goals | Creative | Q5.9 | Marketing Goals & Channels | ⭕ Optional | Priority sliders (1–5) | M, CD, BB | Yes — high-priority follow-up | Nice | Channels | ⭕ Optional | Priority sliders (1–5) | Future: Marketing, CD, BB | Yes — high-priority follow-up | Deferred |

**Summary:** 48 total questions. **25 must-have (V1)**. 8 conditional. 18 optional/nice-to-have (includes 3 moved from V1). 6 deferred to V2/V3.
